...
exports.validateParameterType = validateParameterType;
exports.convertParameterValue = convertParameterValue;
exports.addPagination = addPagination;
exports.getCountQuery = getCountQuery;
 ...
 */
function validateSql(sql, allowDangerous = false) {
 ...
 */
function addPagination(sql, page, pageSize) {
